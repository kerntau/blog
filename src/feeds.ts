	...
	// #region XUPTers
	{
		...
		entries: [
			...
			},
			{
				...
				feed: 'https://blog.yanxisishi.top/atom.xml',
				icon: 'https://blog.yanxisishi.top/favicon.png',
				avatar: getOicqAvatar('3497863696'),
				archs: ['Nuxt', 'Vercel'],
				date: '2026-03-31',
				comment: '网安学弟。',
			},
			{
				author: 'FRiver',
				sitenick: '雨停之后',
				desc: '想把我唱给你听，趁现在年少如花.',
				link: 'https://www.gmaxh.site/',
				icon: 'https://www.gmaxh.site/favicon/avatar.jpeg',
				avatar: 'https://www.gmaxh.site/favicon/avatar.jpeg',
				archs: ['Hexo', 'Vercel'],
				date: '2026-04-21',
				comment: 'Linux系统编程学习中。',
			},
			{
				author: 'XOBear',
